Example to show data flow from timer to Knative KafkaBroker to Webhook
...
## Verify the Events are flowing to Webhook

Verify data on Webhook UI(https://webhook.site/).
